...
alias cls="colorls --gs --tree=4 -r"
alias cla="colorls -l -a --gs -r"
alias clm="colorls --gs -r"
alias we="curl wttr.in/cairo"
alias svm="cmatrix -b -s"
alias svp="bash ~/.pipes.sh/pipes.sh -t 0 -p 5"
alias vit="source .vitVenv/bin/activate && vit"
